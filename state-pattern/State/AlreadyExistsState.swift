...
class AlreadyExistsState: Statable {
    ...
    func handleSaveUserButtonPress() {
        controller.showMessage(
            with: "Oops",
            message: "User cannot be saved because a record with the provided info already exists in the database"
        )
    }
}
